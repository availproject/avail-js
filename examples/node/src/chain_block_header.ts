...
async function main() {
  ...
  if (bestBlockHeader instanceof AvailError) throw bestBlockHeader
  if (finalizedBlockHeader instanceof AvailError) throw finalizedBlockHeader
  if (blockHeader instanceof AvailError) throw blockHeader
