...
import { ExtrinsicSub } from "avail-js/subscription"
...
async function main() {
  ...
  const sub1 = new ExtrinsicSub(avail.dataAvailability.tx.SubmitData, client, {});
  ...
  // Best Block
  const sub2 = new ExtrinsicSub(avail.dataAvailability.tx.SubmitData, client, {});
  ...
  // Historical Blocks
  const sub3 = new ExtrinsicSub(avail.dataAvailability.tx.SubmitData, client, {});
