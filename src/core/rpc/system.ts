...
export async function fetchEventsV1(endpoint: string, blockHash: H256 | string, options?: fetchEventsV1Types.Options | null): Promise<fetchEventsV1Types.RpcResponse> {
