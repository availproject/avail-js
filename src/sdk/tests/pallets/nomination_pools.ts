...
import { Client, MAINNET_ENDPOINT, BN } from "../../."
import { nominationPools } from "../../core/types/pallets"
...
async function tx_test() {
...

  {
    ...
    const submittable = client
      .tx()
      .nominationPools()
      .bondExtra({ FreeBalance: new BN("6740000000000000000") })
    const expectedCall = ICall.decode(nominationPools.tx.BondExtra, submittable.call.method.toU8a())!
    const actualTx = isOkNotNull(await block.ext().get(nominationPools.tx.BondExtra, 1))
    eqJson(actualTx.call, expectedCall)
  }

  {
    ...
    const submittable = client
      .tx()
      .nominationPools()
      .bondExtraOther("0xe48387e8f162d580110568e3df575054de32269822f2362702a8afb1f6914469", "Rewards")
...

  {
    ...
    const submittable = client
      .tx()
      .nominationPools()
      .claimPayoutOther("0x7e1180729a6eebfa4c3b2f6cf2f6c7bf4c09f10f3dc339c6de8e1c14c539e62d")
...

  {
    ...
    const submittable = client
      .tx()
      .nominationPools()
      .setCommission(73, [10000000, "0xec5c245a8405d77710d5d226e354b4236e5e5d13c61fa8ba3fa9aed204b6d6b7"])
...

  {
    ...
    const submittable = client
      .tx()
      .nominationPools()
      .unbond("0xc25a201b2443dac9697558458ccb6b120c079f70b9a72eeeea7914639197e24f", new BN("333000000000000000000"))
...

  {
    ...
    const submittable = client
      .tx()
      .nominationPools()
      .withdrawUnbonded("0x48498d4fdb57d0c11c8e4ec98ffc0a7511563eb73cd2940c5208fc9170bed473", 0)
