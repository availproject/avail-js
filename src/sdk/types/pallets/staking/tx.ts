...
export class Validate extends addHeader(PALLET_ID, 4) {
  ...
  static decode(decoder: Decoder): Validate | ClientError {
...
export class ChillOther extends addHeader(PALLET_ID, 23) {
  ...
  static decode(decoder: Decoder): ChillOther | ClientError {
...
export class PayoutStakers extends addHeader(PALLET_ID, 18) {
  ...
  static decode(decoder: Decoder): PayoutStakers | ClientError {
...
export class SetController extends addHeader(PALLET_ID, 8) {
  ...
  static decode(_decoder: Decoder): SetController | ClientError {
...
export class SetPayee extends addHeader(PALLET_ID, 7) {
  ...
  static decode(decoder: Decoder): SetPayee | ClientError {
...
export class Chill extends addHeader(PALLET_ID, 6) {
  ...
  static decode(_decoder: Decoder): Chill | ClientError {
    return new Chill()
  }
...
export class ReapStash extends addHeader(PALLET_ID, 20) {
  ...
  static decode(decoder: Decoder): ReapStash | ClientError {
...
export class Kick extends addHeader(PALLET_ID, 21) {
  ...
  static decode(decoder: Decoder): Kick | ClientError {
...
export class ForceApplyMinCommission extends addHeader(PALLET_ID, 24) {
  ...
  static decode(decoder: Decoder): ForceApplyMinCommission | ClientError {
...
export class PayoutStakersByPage extends addHeader(PALLET_ID, 26) {
  ...
  static decode(decoder: Decoder): PayoutStakersByPage | ClientError {
