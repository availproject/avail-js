...
export class Nominate extends addHeader(PALLET_ID, 8) {
  ...
  static decode(decoder: Decoder): Nominate | ClientError {
    const poolId = decoder.any1(U32)
    if (poolId instanceof ClientError) return poolId

    const validators = decoder.vec(AccountId)
    if (validators instanceof ClientError) return validators
...
export class SetClaimPermission extends addHeader(PALLET_ID, 15) {
  ...
  static decode(decoder: Decoder): SetClaimPermission | ClientError {
...
export class SetCommission extends addHeader(PALLET_ID, 17) {
  ...
  static decode(decoder: Decoder): SetCommission | ClientError {
    const poolId = decoder.any1(U32)
    if (poolId instanceof ClientError) return poolId

    const newCommission = decoder.optionTuple(U32, AccountId)
    if (newCommission instanceof ClientError) return newCommission
...
export class SetCommissionChangeRate extends addHeader(PALLET_ID, 19) {
  ...
  static decode(decoder: Decoder): SetCommissionChangeRate | ClientError {
...
export class SetCommissionMax extends addHeader(PALLET_ID, 18) {
  ...
  static decode(decoder: Decoder): SetCommissionMax | ClientError {
...
export class SetMetadata extends addHeader(PALLET_ID, 10) {
  ...
  static decode(decoder: Decoder): SetMetadata | ClientError {
...
export class SetState extends addHeader(PALLET_ID, 9) {
  ...
  static decode(decoder: Decoder): SetState | ClientError {
...
export class UpdateRoles extends addHeader(PALLET_ID, 12) {
  ...
  static decode(decoder: Decoder): UpdateRoles | ClientError {
...
export class WithdrawUnbonded extends addHeader(PALLET_ID, 5) {
  ...
  static decode(decoder: Decoder): WithdrawUnbonded | ClientError {
