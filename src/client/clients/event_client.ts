...
export class EventClient {
  ...
  public async transactionEvents(blockHash: Core.H256 | string, txIndex: number, enableEncoding?: boolean, enableDecoding?: boolean): Promise<Types.RuntimeEvent[] | null> {
  ...
  public async blockEvents(blockHash: Core.H256 | string, filter: Types.Filter | null, enableEncoding?: boolean | null, enableDecoding?: boolean | null): Promise<Types.GroupedRuntimeEvents[]> {
