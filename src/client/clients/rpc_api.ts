...
export class RpcApi {
  ...
  public async systemFetchExtrinsicV1(blockId: Core.HashNumber, transactionFilter?: fetchExtrinsicV1Types.TransactionFilterOptions | null, signatureFilter?: fetchExtrinsicV1Types.SignatureFilterOptions | null, encodeAs?: fetchExtrinsicV1Types.EncodeSelector | null): Promise<fetchExtrinsicV1Types.ExtrinsicInformation[]> {
  ...
  public async systemFetchEventsV1(blockHash: Core.H256 | string, filter?: fetchEventsV1Types.Filter | null, enableEncoding?: boolean | null, enableDecoding?: boolean | null): Promise<fetchEventsV1Types.GroupedRuntimeEvents[]> {
