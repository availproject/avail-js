...
;(() => {
  ...
  var Ie = (t, e, r, n) => {
    if ((e && typeof e == "object") || typeof e == "function")
      for (let i of Te(e))
        !Qe.call(t, i) && i !== r && re(t, i, { get: () => e[i], enumerable: !(n = we(e, i)) || n.enumerable })
    return t
  }
  var Ce = (t, e, r) => (
    (r = t != null ? Se(ke(t)) : {}),
...
`,
      ...
      ;(t.Vector = function (e) {
        ...
        (t.Vector.prototype.dot = function (e) {
          for (
            var r = 0, n = this.elements, i = e.elements, s = n.length, o = i.length, a = 0, l = 0, u = 0, d = 0;
            u < s && d < o;

          )
            (a = n[u]),
              (l = i[d]),
              a < l ? (u += 2) : a > l ? (d += 2) : a == l && ((r += n[u + 1] * i[d + 1]), (u += 2), (d += 2))
          return r
        }),
      ...
      ;(t.stemmer = (function () {
        var e = {
          ...
          H = function (c) {
            ...
            if (((h = I), h.test(c))) {
              var L = h.exec(c)
              ;(v = L[1]), (h = y), (x = b), (O = W), (h.test(v) || (x.test(v) && !O.test(v))) && (c = v)
            }
            return (
              (h = z),
              (x = y),
      ...
      ;(t.TokenSet = function () {
            ...
            if (s.editsRemaining != 0) {
              ...
              if (s.str.length > 1) {
                var d = s.str.charAt(0),
                  m = s.str.charAt(1),
                  y
                m in s.node.edges ? (y = s.node.edges[m]) : ((y = new t.TokenSet()), (s.node.edges[m] = y)),
        ...
        (t.TokenSet.prototype.intersect = function (e) {
          for (var r = new t.TokenSet(), n = void 0, i = [{ qNode: e, output: r, node: this }]; i.length; ) {
            n = i.pop()
            for (
              var s = Object.keys(n.qNode.edges), o = s.length, a = Object.keys(n.node.edges), l = a.length, u = 0;
              u < o;
              u++
            )
          ...
          for (var l = 0; l < r.clauses.length; l++) {
            ...
            for (var y = 0; y < d.length; y++) {
              ...
              for (var w = 0; w < E.length; w++)
                for (var S = E[w], k = this.invertedIndex[S], _ = k._index, f = 0; f < u.fields.length; f++) {
                  var p = u.fields[f],
                    B = k[p],
                    A = Object.keys(B),
                    j = S + "/" + p,
      ...
      ;(t.Builder = function () {
        ...
        (t.Builder.prototype.add = function (e, r) {
          ...
          for (var s = 0; s < i.length; s++) {
            ...
            ;(this.fieldTermFrequencies[m] = y), (this.fieldLengths[m] = 0), (this.fieldLengths[m] += d.length)
            for (var b = 0; b < d.length; b++) {
              ...
              this.invertedIndex[g][o][n] == null && (this.invertedIndex[g][o][n] = Object.create(null))
          ...
          for (
            ...
            for (
              ...
              var f = m[E],
                ...
                k,
                _
              i[f] === void 0 ? ((S = t.idf(this.invertedIndex[f], this.documentCount)), (i[f] = S)) : (S = i[f]),
                (k =
                  (S * ((this._k1 + 1) * p)) /
          ...
          if (r != null)
            switch (r.type) {
              ...
              default:
                ...
                throw (
                  (r.str.length >= 1 && (n += " with value '" + r.str + "'"), new t.QueryParseError(n, r.start, r.end))
                )
            }
        }),
    ...
    createComponents(e) {
      ne.forEach((r) => {
        e.querySelectorAll(r.selector).forEach((n) => {
          n.dataset.hasInstance || (new r.constructor({ el: n, app: this }), (n.dataset.hasInstance = String(!0)))
        })
      })
    }
    filterChanged() {
  ...
  function Oe(t, e, r, n) {
    ...
    r.addEventListener("keydown", (s) => {
      ...
      document.body.addEventListener("keydown", (s) => {
        s.altKey || s.ctrlKey || s.metaKey || (!r.matches(":focus") && s.key === "/" && (r.focus(), s.preventDefault()))
      })
  }
  function _e(t, e) {
    t.index ||
    ...
    handleValueChange() {
      ;(this.el.checked = this.value),
        ...
        document.querySelectorAll(".tsd-index-section").forEach((r) => {
          ...
          let n = Array.from(r.querySelectorAll(".tsd-index-link")).every((i) => i.offsetParent == null)
