          ...
          [
              ...
              value: function (e, t, n, r) {
                ...
                return (
                  ...
                  this.compareNodeIframe(e, t, n)
                    ? (!1 !== i || o ? !1 === i || o || (r[i].handled = !0) : r.push({ val: n, handled: !0 }), !0)
            ...
            },
            {
              ...
              value: function (e, t, n, r, i) {
                for (
                  var o, a = this, s = this.createIterator(t, e, r), c = [], u = [], l = void 0, h = void 0;
                  void 0, (o = a.getIteratorNode(s)), (h = o.prevNode), (l = o.node);
              ...
              for (var i in t)
                if (t.hasOwnProperty(i)) {
                  ...
                  "" !== a &&
                    "" !== s &&
                    (e = e.replace(
                      new RegExp("(" + this.escapeStr(a) + "|" + this.escapeStr(s) + ")", "gm" + n),
                      r + "(" + this.processSynonyms(a) + "|" + this.processSynonyms(s) + ")" + r,
                    ))
                }
              return e
            },
            ...
            value: function (e, t, n) {
              ...
              return (
                (r = (s = s > o ? o : s) + parseInt(e.length, 10)) > o &&
                  ((r = o), this.log("End range automatically set to the max value of " + o)),
                s < 0 || r - s < 0 || s > o || r > o
                  ? ((i = !1), this.log("Invalid range: " + JSON.stringify(e)), this.opt.noMatch(e))
                  : "" === n.substring(s, r).replace(/\s+/g, "") &&
                    ((i = !1), this.log("Skipping whitespace only range: " + JSON.stringify(e)), this.opt.noMatch(e)),
