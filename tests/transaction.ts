...
import { BN, ONE_AVAIL, u8aToHex as hex } from "../src/client"
...
function decoded_transaction() {
  ...
  // Nonce: 4
  {
    const tx =
      ""
    const decodedTransaction = DecodedTransaction.decodeHex(Utility.Tx.Batch, tx)!
    ...
    assertEq(decodedTransaction.call.length(), 2)

    const calls = decodedTransaction.call.decodeCalls()!
    assertEq(calls.length, 2)
