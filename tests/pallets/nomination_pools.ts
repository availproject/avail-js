...
async function tx_test() {
...

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.BondExtra, 1))
...

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.BondExtraOther, 2))
    assertEqJson(actualCall, expectedCall)
  }

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.Chill, 1))
    assertEqJson(actualCall, expectedCall)
  }

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.ClaimCommission, 1))
    assertEqJson(actualCall, expectedCall)
  }

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.ClaimPayout, 1))
    assertEqJson(actualCall, expectedCall)
  }

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.ClaimPayoutOther, 1))
    assertEqJson(actualCall, expectedCall)
  }

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.Create, 14))
    assertEqJson(actualCall, expectedCall)
  }

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.CreateWithPoolId, 1))
    assertEqJson(actualCall, expectedCall)
  }

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.Join, 2))
    assertEqJson(actualCall, expectedCall)
  }

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.Nominate, 1))
    assertEqJson(actualCall, expectedCall)
  }

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.SetClaimPermission, 1))
    assertEqJson(actualCall, expectedCall)
  }
...

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.SetCommission, 1))
    assertEqJson(actualCall, expectedCall)
  }
...

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.SetCommissionChangeRate, 1))
    assertEqJson(actualCall, expectedCall)
  }

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.SetCommissionMax, 1))
    assertEqJson(actualCall, expectedCall)
  }

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.SetMetadata, 1))
    assertEqJson(actualCall, expectedCall)
  }

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.SetState, 4))
    assertEqJson(actualCall, expectedCall)
  }

  {
    ...
    const expectedCall = ICall.decode(nominationPools.tx.SetState, submittable.call.method.toU8a())!
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.SetState, 1))
    assertEqJson(actualCall, expectedCall)
  }

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.Unbond, 1))
    assertEqJson(actualCall, expectedCall)
  }

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.UpdateRoles, 1))
    assertEqJson(actualCall, expectedCall)
  }
...

  {
    ...
    const [actualCall] = isOkAndNotNull(await block.tx(nominationPools.tx.WithdrawUnbonded, 1))
    assertEqJson(actualCall, expectedCall)
  }
}
