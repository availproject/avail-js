...
async function tx_test() {
  const client = isOk(await Client.create(MAINNET_ENDPOINT))
  {
    ...
    const submittable = client
      .tx()
      .proxy()
      .addProxy("0xa6668ecbef4f8b0c64e294a9addc0fb267ec02cb0e0c3f74f3a45b8f1043c774", "NonTransfer", 0)
...

  {
    ...
    const submittable = client
      .tx()
      .proxy()
      .proxy("0xaabd39bb20728ec512a104178c2244703ae900eb3368ddcd3f8dbf6ed6151696", null, call)
...

  {
    ...
    const submittable = client
      .tx()
      .proxy()
      .removeProxy("0x685302266408090333837daf4c1fee2b23c5a7f055b61f6e8d16ad6662b28b39", "Staking", 0)
